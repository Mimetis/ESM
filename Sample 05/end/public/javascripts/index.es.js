...
class speakersPage {
    ...
    async onLoad() {
        ...
        var viewOptions = router$1.getCurrentViewOptions();
        ...
        this.prevLink.click(() => {
            router$1.navigateTo(`/speakers/${prevPageIndex}`);
        });
        this.nextLink.click(() => {
            router$1.navigateTo(`/speakers/${pageIndex + 1}`);
        });
...
class speakerPage {
    ...
    async onLoad() {
        ...
        let queryParameters = router$1.getQueryParameters();

        let state = router$1.getCurrentState();
...
router$1.register('speaker', speakerPage);
router$1.register('speakers', speakersPage);
router$1.register('conferences', conferencesPage);
